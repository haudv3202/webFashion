                        ...
                        <div class="card">
                            <div class="card-body flex flex-col p-6">
                                ...
                                <div class="card-text h-full ">
                                    <form class="space-y-4" action="{{ route('products.create') }}" method="post" enctype="multipart/form-data">
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
                                            @csrf
                                            <div class="input-area relative">
                                                <label for="largeInput" class="form-label">Tên Sản phẩm</label>
                                                <input type="text" name="nameProduct" class="form-control" value="{{ old('nameProduct') }}" placeholder="Full Title">
                                                @error('nameProduct')
                    ...
                    <span id="placeholders" class="text-slate-400">Choose a file or drop it here...</span>
                              ...
                              <span class="file-name flex-none cursor-pointer border-l px-4 border-slate-200 dark:border-slate-700 h-full inline-flex items-center bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-400 text-sm rounded-tr rounded-br font-normal">Browse</span>
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="price" class="form-control" value="{{ old('price') }}" placeholder="Full Title">
                                                @error('price')
                                                <div class="py-[18px] mt-4 px-6 font-normal font-Inter text-sm rounded-md bg-danger-500 bg-opacity-[14%] text-danger-500">
                                                    <div class="flex items-start space-x-3 rtl:space-x-reverse">
                                                        <div class="flex-1">
                                            ...
                                            <div class="input-area relative">
                                                ...
                                                <input type="text" name="sale" class="form-control" value="{{ old('sale') }}" placeholder="Full Title">
                                                @error('sale')
                                                <div class="py-[18px] mt-4 px-6 font-normal font-Inter text-sm rounded-md bg-danger-500 bg-opacity-[14%] text-danger-500">
                                                    <div class="flex items-start space-x-3 rtl:space-x-reverse">
                                                        <div class="flex-1">
                                            ...
                                            <div class="input-area">
                                                ...
                                                <select id="select" name="categories" class="form-control">
                                                    ...
                                                    @foreach($categories as $value)
                                                        <option value="{{ $value->id }}" {{ old('categories') == $value->id ? 'selected' : '' }} class="dark:bg-slate-700">{{ $value->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('categories')
                                                <div class="py-[18px] mt-4 px-6 font-normal font-Inter text-sm rounded-md bg-danger-500 bg-opacity-[14%] text-danger-500">
                                            ...
                                            <div class="input-area">
                                                ...
                                                <select id="select" name="brand_id" class="form-control">
                                                    ...
                                                    <option value="{{ $value->id }}" {{ old('brand_id') == $value->id ? 'selected' : '' }} class="dark:bg-slate-700">{{ $value->name }}</option>
                                                    @endforeach
                                                </select>
                                                @error('brand_id')
                                                <div class="py-[18px] mt-4 px-6 font-normal font-Inter text-sm rounded-md bg-danger-500 bg-opacity-[14%] text-danger-500">
