        ...
        <div class="page-content">
            <div class="transition-all duration-150 container-fluid" id="page_layout">
                    ...
                    <div class=" space-y-5">
                        <div class="card">
                            <header class=" card-header noborder">
                                <h4 class="card-title">Quản lí danh mục
                                </h4>
                                        ...
                                        <div class="overflow-hidden ">
                                            <table
                                                ...
                                                <tr id="record-{{$value->id}}">
                                                    ...
                                                    <td class="table-td "><img src="{{ asset($value->images) }}" alt=""></td>
                                                    <td class="table-td ">{{ number_format($value->price) }}₫</td>
                                                    <td class="table-td ">{{ $value->discount_price }}</td>
                                                    <td class="table-td ">{{ $value->view }}</td>
                                                    <td class="table-td ">{{ $value->like }}</td>
                                                    <td class="table-td ">
                                                    ...
                                                    <td class="table-td ">{{ $value->categories->first()->name }}</td>
                                                    <td class="table-td ">{{ $value->brand->first()->name }}</td>
                                                    <td class="table-td ">
                                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                                            <button class="action-btn" onclick="location.href='{{ route('products.edit',['id' => $value->id]) }}'" type="button">
                                                                <iconify-icon
                                            ...
                                            <ul class="list-none">
                                                <!-- Your existing HTML structure for pagination -->
                                                <ul class="list-none">
                ...
                <iconify-icon icon="material-symbols:arrow-back-ios-rounded"></iconify-icon>
                                                        ...
                                                        @else
                                                            <a href="{{ $data->previousPageUrl() }}" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800
                    ...
                    duration-300 relative top-[2px] pl-2">
                                                    ...
                                                    <li class="inline-block">
                                                        ...
                                                        @if ($data->hasMorePages())
                                                            <a href="{{ $data->nextPageUrl() }}" class="flex items-center justify-center w-6 h-6 bg-slate-100 dark:bg-slate-700 dark:hover:bg-black-500 text-slate-800
                    dark:text-white rounded mx-[3px] sm:mx-1 hover:bg-black-500 hover:text-white text-sm font-Inter font-medium transition-all
