...
@section('title-page','Cấu hình bản tin')
@section('content')
    <!-- CSS -->
                    ...
                    <div class=" space-y-5">
                        <div class="card">
                            <header class=" card-header noborder">
                                <h4 class="card-title">Tin Tức Khuyến mại
                                </h4>
                                <button onclick="location.href='{{ route('newletter.add') }}'"
                                        ...
                                        <div class="overflow-hidden ">
                                            <table
                                                ...
                                                <tr id="record-{{$value->id}}">
                                                    ...
                                                    <td class="table-td ">{{ $value->des_newleter }}</td>
                                                    <td class="table-td ">
                                                    ...
                                                    <td class="table-td ">
                                                        <div class="flex space-x-3 rtl:space-x-reverse">
                                                            <button class="action-btn" onclick="location.href='{{ route('newletter.edit',['id' => $value->id]) }}'" type="button">
                                                                <iconify-icon
