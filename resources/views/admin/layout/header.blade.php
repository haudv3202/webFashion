<div>
    ...
    <div class="z-[9]" id="app_header">
        ...
        <img src="{{ asset('admin/assets/images/logo/logo.svg') }}" class="black_logo " alt="logo">
        <img src="{{ asset('admin/assets/images/logo/logo-white.svg') }}" class="white_logo" alt="logo">
    </span>
      ...
      overflow-hidden">
            ...
            dark:text-white font-normal">
                                ...
                                <li>
                                    <a href="{{ route('auth.logout') }}" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
